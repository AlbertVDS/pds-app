<template>
  <div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
      ...
      <router-link to="/admin/users/create" class="bg-blue-600 text-white px-4 py-2 rounded">
        Create User
      </router-link>
    </div>
        ...
        <tbody>
          <tr v-for="user in users" :key="user.id" class="border-b hover:bg-gray-50">
            ...
            <td class="px-6 py-4 space-x-2">
              <router-link :to="`/admin/users/${user.id}/edit`" class="text-blue-600 hover:underline">Edit</router-link>
