...
@section('content')
        ...
        <div class="mb-3">
            <label for="mailing-group" class="form-label">{{ translate('Mailing group') }}</label>
            <select class="form-select" aria-label="Select mailing group" id="mailing-group" name="mailing_group_id">
                <option selected>{{ translate('Select mailing group') }}</option>
        ...
        <div class="mb-3">
            <label for="schedule-date" class="form-label">{{ translate('Scheduled for') }}</label>
        ...
        <div class="mb-3s">
            <label for="email-body" class="form-label">{{ translate('Email body') }}</label>
