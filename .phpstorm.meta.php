...
'gemini.api_key','gemini.base_url','gemini.request_timeout','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','sanctum.csrf-cookie','foods.index','foods.show','recipes.index',
'recipes.show','foods.index','foods.create',
'foods.store','foods.show','foods.edit','foods.update','foods.destroy',
'mailing.index','mailing.create','mailing.store','mailing.show','mailing.edit',
'mailing.update','mailing.destroy','save-linked-foods','save-substitute','mailings.index',
'mailings.create','mailings.store','mailings.show','mailings.edit','mailings.update',
'mailings.destroy','roles.index','roles.create','roles.store','roles.show',
'roles.edit','roles.update','roles.destroy','recipe-ingredients.index','translations.index',
'translations.create','translations.store','translations.show','translations.edit','translations.update',
'translations.destroy','users.index','users.create','users.store','users.show',
'users.edit','users.update','users.destroy','profiles.user.index','profiles.user.create',
'profiles.user.store','profiles.user.show','profiles.user.edit','profiles.user.update','profiles.user.destroy',
'tokens.create','login','logout','register','area-autocomplete',
'category-autocomplete','food-autocomplete','food-type-autocomplete','ingredient-autocomplete','tag-autocomplete',
'foods.index','recipes.index','recipes.show','user.settings','user.settings.update',
'user.favorite-recipes','user.favorite-recipe.store','user.favorite-recipe.destroy','login','storage.local',);
        registerArgumentsSet('views', 
'foods.contains','foods.details','foods.index','foods.level','home',
'layout-parts.admin-sidebar','layout-parts.footer','layout-parts.logged-in','layout-parts.login-register','layout-parts.main',
'layout-parts.select2','layout-parts.sidebar','mailing.create-edit','mailing.index','mailing.template',
'profile.edit','profile.favorite-recipes','profile.index','recipe-ingredients.index','recipes.index',
'recipes.show','translations.edit','translations.index','translations.show','users.edit',
'users.favorite-recipes','users.index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'nl.0','flasher::messages.success','flasher::messages.error','flasher::messages.warning','flasher::messages.info',
'flasher::messages.The resource was created','flasher::messages.The resource was updated','flasher::messages.The resource was saved','flasher::messages.The resource was deleted','flasher::messages.resource',);
